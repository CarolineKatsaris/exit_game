       ...
       // loginView.errorLabel.setVisible(true);
        ...
        if (screen.isShowIntro()) {
            ...
            if (screen.getTitle() == EnumScreen.Hub) {
                ...
                screen.isIntroShown(); //ToDo View sollte per Event Modell benachrichtigen, wenn Intro vorbei ist, so dass die dann isIntroShown aufrufen kann und das aktualisierte Screen Objekt per property change erneut an die View senden kann
